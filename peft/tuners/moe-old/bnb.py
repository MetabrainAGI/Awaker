...
from .layer import LoraMoeLayer


if is_bnb_available():

    class Linear8bitLt(torch.nn.Module, LoraMoeLayer):
        ...
        def __init__(
            ...
            **kwargs,
            ...
            super().__init__()
            LoraMoeLayer.__init__(self, in_features=base_layer.in_features, out_features=base_layer.out_features)
...
if is_bnb_4bit_available():
    ...
    class Linear4bit(torch.nn.Module, LoraMoeLayer):
        # Lora implemented in a dense layer
        def __init__(
            self,
            adapter_name,
